...
const PRICES = {
  monthly: {
    UGX: { starter: "150,000 UGX", standard: "300,000 UGX", pro: "500,000 UGX" },
    USD: { starter: "$42", standard: "$83", pro: "$139" },
  },
  yearly: {
    UGX: { starter: "1,500,000 UGX", standard: "3,000,000 UGX", pro: "5,000,000 UGX" },
    USD: { starter: "$417", standard: "$833", pro: "$1,389" },
  },
};

const features = {
  starter: ["Up to 200 students", "Student & fee management", "Basic attendance tracking", "Parent SMS notifications", "Email support", "1 campus"],
  standard: ["Up to 1,000 students", "Full academic management", "Timetabling & exams", "Parent portal", "Priority support", "2 campuses"],
  pro: ["Unlimited students", "Multi-campus support", "Advanced analytics", "Custom report cards", "API access & integrations", "Dedicated support"],
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-7xl mx-auto">
          ...
          <Card className="border-slate-200 bg-white shadow-sm relative overflow-hidden flex flex-col">
            <CardHeader className="pb-4">
              ...
              <div className="mt-4">
                <span className="text-4xl font-bold text-slate-900">{prices.starter}</span>
              </div>
              <CardDescription className="mt-2 text-slate-500">Perfect for small schools getting started.</CardDescription>
            </CardHeader>
          ...
          <Card className="shadow-lg relative overflow-hidden flex flex-col" style={{ borderColor: primaryColor, borderWidth: "2px" }}>
            ...
            <CardHeader className="pb-4 pt-10">
              ...
              <CardDescription className="mt-2 text-slate-500">For growing schools with more needs.</CardDescription>
            </CardHeader>
            <CardContent className="flex-grow">
              <Link href="/contact-us">
          ...
          <Card className="border-slate-200 bg-white shadow-sm relative overflow-hidden flex flex-col">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="mt-2 text-slate-500">Enterprise-grade for large institutions.</CardDescription>
            </CardHeader>
            <CardContent className="flex-grow">
              <Link href="/contact-us">
        ...
        <Card className="max-w-7xl mx-auto border-slate-200 bg-slate-50">
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription className="mt-2 text-slate-600">Need a tailored School Sync deployment for your institution network? Let&apos;s build it together.</CardDescription>
              </div>
              <Star className="w-4 h-4 text-slate-400 fill-slate-400" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {["Multi-institution management", "Custom integrations & API", "Dedicated support and maintenance", "White-label branding options"].map((item, i) => (
