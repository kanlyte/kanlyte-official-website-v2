...
const milestones = [
  {
    ...
    description:
      "Kanlyte Uganda Limited was founded with a clear vision: to unleash the power of software through comprehensive digital transformation. Incorporated in Uganda and registered by the Uganda Registration Bureau of Standards (URSB), we began our journey committed to delivering innovative solutions while empowering communities through technology.",
    year: "2022",
    image: "/team-images/team-1.jpg",
    alt: "Kanlyte office establishment and founding team",
  },
  {
    title: "Service Portfolio Expansion",
    description:
      "We rapidly expanded our services to include software & systems design, mobile app development, website design, UI/UX design, graphics design, domain registry, professional emails, and web hosting. Our commitment to integrity, honesty, reliability, timeliness, quality, and affordability established us across public, private, NGO, startup, and individual sectors.",
    year: "2023",
    image: "/images/beacon.jpg",
    alt: "Kanlyte team working on diverse projects and services",
  },
  {
    ...
    year: "2024-2025",
    image: "/images/odoo-team.jpg",
    alt: "Kanlyte technology stack and innovation center",
  },
  {
    title: "Digital Infrastructure Growth",
    description:
      "We established comprehensive cloud services including data backup, project management tools, and automated business services. Our expertise expanded to network installation, security systems, smart devices, time and attendance systems, and business automation - providing integrated solutions for residential and commercial environments.",
    year: "2025",
    image: "/images/lyteapp1.jpeg",
    alt: "Kanlyte digital infrastructure and network setup",
  },
  {
    title: "Future Vision & Impact",
    description:
      "Looking ahead, Kanlyte continues its mission of empowering individuals and communities through software. With applications like Iyte app and GET IT ON in production, we&apos;re committed to achieving 90% client retention, engaging in community outreach, and impacting the younger generation to align with digital development for a brighter future.",
    year: "2025+",
    image: "/images/aaa.jpg",
    alt: "Kanlyte team planning future projects and innovations",
  },
];
    ...
    <section className="relative py-20 overflow-hidden bg-gradient-to-b from-white to-gray-50/30">
      <div className="text-center mb-24 px-4">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed text-base md:text-lg">
          From our founding to future aspirations - tracing Kanlyte&apos;s
          evolution as a pioneering force in Uganda&apos;s digital
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        ...
        {milestones.map((item, index) => (
          <div
            key={index}
            className={`flex flex-col md:flex-row items-center gap-8 md:gap-16 mb-12 md:mb-[-12px] relative z-10 ${
          ...
          >
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 z-20 hidden md:flex">
              <div className="relative">
                <div className="w-16 h-16 bg-white rounded-full border-4 border-[#6EBE45] flex items-center justify-center shadow-lg">
                  <span className="text-[#6EBE45] font-bold text-sm">
                    {item.year}
                  </span>
                </div>
              </div>
            ...
            <div className="relative w-full md:w-1/2 flex justify-center">
              <div
                className={`relative p-2 border-[12px] border-[#6EBE45]/20 bg-white w-full max-w-[500px] aspect-[1.2/1] ${
                  index % 2 === 0
                    ? "rounded-l-[1000px] border-r-0 rounded-r-none"
                    : "rounded-r-[1000px] border-l-0 rounded-l-none"
                }`}
              >
                <div
                  className={`w-full h-full overflow-hidden ${
                    index % 2 === 0 ? "rounded-l-[950px]" : "rounded-r-[950px]"
                  }`}
                >
                ...
                <div
                  ...
                  } top-6 bg-[#6EBE45] text-white px-4 py-2 rounded-lg font-bold text-sm shadow-lg`}
                >
                  {item.year}
                </div>
              </div>
            ...
            {/* Content Section */}
            <div
              className={`w-full md:w-1/2 flex flex-col justify-center space-y-5 py-12 ${
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-semibold text-[#6EBE45] uppercase tracking-wide">
                  Milestone {index + 1}
                </span>
                <div className="w-10 h-0.5 bg-[#6EBE45]" />
              </div>
              ...
              <div className="pt-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#6EBE45]/10 rounded-lg border border-[#6EBE45]/20">
                  ...
                  <span className="text-[#6EBE45] font-medium text-sm">
                    Year: {item.year}
                  </span>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Key moments in Kanlyte&apos;s journey captured through our work
            </p>
          </div>
