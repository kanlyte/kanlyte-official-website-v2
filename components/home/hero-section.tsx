...
const slides = [
  ...
  },
  {
    ...
    description: "Innovative Solutions That Drive Growth",
  ...
  },
  {
    ...
    description: "Bespoke Software That Scales",
    buttonText: "Explore Odoo solutions",
    buttonLink: "/odoo",
  },
];
...
export default function HeroSlider() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        aria-label={`${slides[currentSlide].buttonText} about ${slides[currentSlide].title}`}
                      >
      ...
      {/* Mobile Navigation Controls (Bottom) - Enhanced with green */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20">
        <div className="flex items-center gap-4 backdrop-blur-sm bg-black/20 rounded-full px-3 py-2 border border-white/10">
          {/* Play/Pause Button - Mobile friendly */}
          <button
      ...
      {/* Progress Bar - Only show on desktop with green color */}
      ...
      <div className="absolute top-8 right-8 z-20 hidden md:block">
        <div className="backdrop-blur-sm bg-black/30 rounded-xl px-3 py-1.5 border border-white/10">
          <div className="text-white font-medium text-sm">
            <span className="text-[#A5E68A]">{currentSlide + 1}</span>
