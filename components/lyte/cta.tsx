  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Interested in Lyte?</h2>
        <p className="text-slate-500 text-lg mb-8 max-w-xl mx-auto">
          Pricing is tailored to your needs — whether you&apos;re a landlord, agent, or institution. Reach out and we&apos;ll put together the right plan for you.
        </p>
