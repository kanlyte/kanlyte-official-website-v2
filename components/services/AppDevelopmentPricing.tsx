...
const features = {
  core: ["1 platform (iOS or Android)", "Up to 6 screens", "UI/UX design included", "Basic backend/API", "App Store submission", "2 months support"],
  advanced: ["iOS + Android", "Custom UI/UX design", "Full backend & API", "Push notifications", "Payment integration", "6 months support"],
  premium: ["Multi-platform", "Offline functionality", "Enterprise integrations", "Advanced security", "SLA support", "Dedicated team"],
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-7xl mx-auto">
          ...
          <Card className="shadow-lg relative overflow-hidden flex flex-col" style={{ borderColor: primaryColor, borderWidth: "2px" }}>
            ...
            <CardHeader className="pb-4 pt-10">
              ...
              <div className="mt-4">
                <span className="text-4xl font-bold text-slate-900">From 10M UGX</span>
              </div>
