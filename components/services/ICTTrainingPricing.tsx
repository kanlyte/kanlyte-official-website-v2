...
const PRICING_DATA = {
  monthly: { core: "150,000", advanced: "500,000", period: "/ month" },
  yearly: { core: "1,500,000", advanced: "5,000,000", period: "/ year" },
};

const features = {
  core: ["Access to 1 course track", "Hands-on lab exercises", "Certificate of completion", "Community forum access", "Email support"],
  advanced: ["Access to all course tracks", "Instructor-led sessions", "Team progress dashboard", "Recognised certificates", "Priority support", "Custom schedule"],
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-7xl mx-auto">
          ...
          <Card className="border-slate-200 bg-white shadow-sm relative overflow-hidden flex flex-col">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="mt-2 text-slate-500">For self-paced learners {current.period}.</CardDescription>
            </CardHeader>
          ...
          <Card className="shadow-lg relative overflow-hidden flex flex-col" style={{ borderColor: primaryColor, borderWidth: "2px" }}>
            ...
            <CardHeader className="pb-4 pt-10">
              ...
              <CardDescription className="mt-2 text-slate-500">For small teams (up to 10) {current.period}.</CardDescription>
            </CardHeader>
            <CardContent className="flex-grow">
              <Link href="/contact-us">
          ...
          <Card className="border-slate-200 bg-white shadow-sm relative overflow-hidden flex flex-col">
            ...
            <CardContent className="flex-grow">
              ...
              <div className="space-y-4">
                <p className="font-semibold text-sm text-slate-900">What&apos;s included:</p>
                <ul className="space-y-3">
                  {["Unlimited staff", "On-site or remote delivery", "Custom curriculum", "Mentorship & coaching", "Progress reporting", "Dedicated trainer"].map((f, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm text-slate-600">
                      <Check className="w-4 h-4 mt-0.5 shrink-0" style={{ color: primaryColor }} />
                      {f}
                    </li>
