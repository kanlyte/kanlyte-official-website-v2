...
const COLUMNS: ResourceColumn[] = [
  ...
  { key: "priceUGX", label: "Price (UGX)" },
  { key: "isPopular", label: "Popular", render: (v) => v ? <Badge>Popular</Badge> : <span className="text-muted-foreground text-xs">—</span> },
...
export default function PricingPlansPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <ResourceHeader title="Pricing Plans" description="Manage all pricing plans across service categories." resource={RESOURCE} />
