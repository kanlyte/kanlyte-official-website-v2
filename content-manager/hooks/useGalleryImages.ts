...
export function useGalleryImages(activeOnly = false) {
...
export function useCreateGalleryImage() {
  ...
  return useMutation({
    mutationFn: (data: CreateGalleryImageInput) =>
...
export function useUpdateGalleryImage() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: UpdateGalleryImageInput }) =>
